...
local renowned_enabled = minetest.get_modpath("renowned_rpg")
		...
		or (self.attack_type == "dogshoot" and dist > self.reach and dogswitch(self) == 0) then
			...
			and random(1, 100) <= 60 then
				...
				if minetest.registered_entities[self.arrow] then
					...
					-- renowned rpg modification to pass along mob attk value to arrow entity
					if renowned_enabled then
					    local mob_entity = self.object:get_luaentity()
					    print("--------------arrow data-------------------")
					    --print(dump(self.object))
					    --print(dump(mob_entity))
						ent.renowned_attk = mob_entity.renowned_attk or mob_entity.damage
					end
					------------------------------------------------------------------------
